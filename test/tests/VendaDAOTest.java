...
public class VendaDAOTest {
	...
	@Test
	public void atualizarEstoqueCompraFinalizada() throws DAOException, TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException {
		...
		assertEquals(produtoConsultado.getEstoque().getQuantidadeEstoque(),produto.getEstoque().getQuantidadeEstoque());
		...
		Produto produtoConsultado2 =  produtoDao.consultar(produto.getCodigo());
		Integer quantidadeEsperadaNoEstoque = produto.getEstoque().getQuantidadeEstoque() - vendaConsultada.getQuantidadeTotalProdutos();
		assertEquals(quantidadeEsperadaNoEstoque, produtoConsultado2.getEstoque().getQuantidadeEstoque());
	}

	@Test
	public void naoAtualizarEstoqueCompraCancelada() throws DAOException, TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException {
		String codigoVenda = "A12";
		Venda venda = criarVenda(codigoVenda);
		Boolean retorno = vendaDao.cadastrar(venda);
		assertTrue(retorno);
		...
		Produto produtoConsultado2 =  produtoDao.consultar(produto.getCodigo());
		Integer quantidadeEsperadaNoEstoque = produto.getEstoque().getQuantidadeEstoque();
		assertEquals(quantidadeEsperadaNoEstoque, produtoConsultado2.getEstoque().getQuantidadeEstoque());
	}
	...
	private Produto cadastrarProduto(String codigo, BigDecimal valor) throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		estoque.setQuantidadeEstoque(20);
